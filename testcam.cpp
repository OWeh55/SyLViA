  ...
  try
    {
      ...
      vector<Vector3d> xyz;
      vector<Point> uv;
      xyz.push_back(Vector3d(0, 0, 0));
      uv.push_back(Point(0, 0));
      xyz.push_back(Vector3d(1, 0, 0));
      uv.push_back(Point(-1, 0));
      xyz.push_back(Vector3d(0, 1, 0));
      uv.push_back(Point(0, 1));
      xyz.push_back(Vector3d(1, 1, 0));
      uv.push_back(Point(-1, 1));

      xyz.push_back(Vector3d(0, 0, 10));
      uv.push_back(Point(0,     0));
      xyz.push_back(Vector3d(1, 0, 10));
      uv.push_back(Point(-1.01, 0));
      xyz.push_back(Vector3d(0, 1, 10));
      uv.push_back(Point(0,     1.01));
      xyz.push_back(Vector3d(1, 1, 10));
      uv.push_back(Point(-1.01, 1.01));
