...
calibrate: calibrate.o cal_findmarker.o FileName.o $(ICEDIR)/lib/$(MACHTYPE)/libice.a
	$(CXX) $(LOPT) $(LIBRARY) -o calibrate calibrate.o FileName.o cal_findmarker.o $(LIBS)
